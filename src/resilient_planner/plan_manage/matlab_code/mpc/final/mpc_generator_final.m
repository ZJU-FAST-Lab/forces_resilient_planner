...
solver_name = strcat('FORCESNLPsolver_final');
...
fprintf('[%s] Final Generating new FORCES solver...\n',datestr(now,'HH:MM:SS'));
FORCES_NLP(model, codeoptions);
fprintf('[%s] Final FORCES solver generated OK \n',datestr(now,'HH:MM:SS'));

%% Storing the solver
% create a folder
folder_name = '../solver/final';

files_name =  './matlab_solver/final';
