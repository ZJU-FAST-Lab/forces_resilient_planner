% FORCESNLPsolver_final - a fast solver generated by FORCESPRO v4.4.0
%
%   OUTPUT = FORCESNLPsolver_final(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = FORCESNLPsolver_final(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver_final(PARAMS) returns 
