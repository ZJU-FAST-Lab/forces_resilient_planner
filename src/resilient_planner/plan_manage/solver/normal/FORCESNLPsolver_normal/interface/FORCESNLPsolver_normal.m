% FORCESNLPsolver_normal - a fast solver generated by FORCESPRO v4.4.0
%
%   OUTPUT = FORCESNLPsolver_normal(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = FORCESNLPsolver_normal(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver_normal(PARAMS) returns 
